...
let allWins = [];
let nbrOfWin = 0;
// Threshold for of weight (determined by optimizer) to skip the heuristic
let doNothingThreshold = 0.01;
 ...
 */
function goalPath(state, weight=-11) {
	if(weight <= doNothingThreshold && weight >= -doNothingThreshold) 
	{
		return 0;
	} 

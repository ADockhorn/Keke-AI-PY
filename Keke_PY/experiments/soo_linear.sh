...
#SBATCH --array=0-4                   # Es werden 5 Tasks mit den IDs von 0-4 gestartet
#SBATCH --cpus-per-task=20
#SBATCH --mem-per-cpu=4G
#SBATCH --time=12:00:00
#SBATCH --output=soo_%A_%a-out.txt   # Logdatei für den merged STDOUT/STDERR output (%A wird durch slurm Job-ID ersetzt und %a durch den Array Index)

...
#SBATCH --job-name=KekeScalingTestCpus16          # Name unter dem der Job in der Job-History gespeichert wird
...
#        later 06:00:00
#SBATCH --output=scaling_test_16_cpus_%A_%a-out.txt   # Logdatei für den merged STDOUT/STDERR output (%A wird durch slurm Job-ID ersetzt und %a durch den Array Index)
...
python Keke_PY/scaling_tests/scaling_test.py 16
